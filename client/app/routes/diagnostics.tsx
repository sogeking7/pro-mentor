            ...
            {[
              {
                ...
                description:
                  "16 тұлға типінің біреуін анықтап, күшті және әлсіз жақтарыңызды біліңіз",
                time: "15 минут",
                icon: "🧠",
                color: "blue",
              },
              {
                title: "Эмоционалдық интеллект",
                description:
                  "Эмоцияларды басқару және түсіну қабілетіңізді тексеріңіз",
                time: "10 минут",
                icon: "❤️",
                color: "red",
              },
              ...
              },
              {
                ...
                description:
                  "Қиын жағдайларға төтеп беру қабілетіңізді бағалаңыз",
                time: "8 минут",
                icon: "🛡️",
                color: "green",
              },
              {
                ...
                description:
                  "Шығармашылық қабілеттеріңіз бен инновациялық ойлауыңыз",
                time: "20 минут",
                icon: "🎨",
                color: "purple",
              },
              {
                ...
                description:
                  "Топтық жұмыстағы рөліңіз және ықпал етуші факторлар",
                time: "10 минут",
                icon: "🤝",
                color: "indigo",
              },
